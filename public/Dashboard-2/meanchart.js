...
var ctx2 = document.getElementById('myChartDash2').getContext('2d');

socket.on ("chart2", (message)=>{
  var myChart = null
  if (myChart!=null){
    myChart.destroy()
  } 
